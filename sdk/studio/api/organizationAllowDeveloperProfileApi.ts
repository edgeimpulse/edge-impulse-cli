...
export class OrganizationAllowDeveloperProfileApi {
    ...
    public setApiKey(key: OrganizationAllowDeveloperProfileApiApiKeys, value: string) {
     ...
     */
    public async createOrganizationPipeline (organizationId: number, organizationUpdatePipelineBody: OrganizationUpdatePipelineBody, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreatePipelineResponse;  }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CreatePipelineResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     */
    public async deleteOrganizationPipeline (organizationId: number, pipelineId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericApiResponse;  }> {
     ...
     */
    public async downloadOrganizationJobsLogs (organizationId: number, jobId: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
     ...
     * @param pipelineId Pipeline ID
     */
    public async getOrganizationPipeline (organizationId: number, pipelineId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetOrganizationPipelinesResponse;  }> {
        const localVarPath = this.basePath + '/api/organizations/{organizationId}/pipelines/{pipelineId}'
            .replace('{' + 'organizationId' + '}', encodeURIComponent(String(organizationId)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
        let localVarQueryParameters: any = {};
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetOrganizationPipelinesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     */
    public async listAllOrganizationJobs (organizationId: number, startDate?: Date, endDate?: Date, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListJobsResponse;  }> {
     ...
     * @param offset Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.
     */
    public async listFinishedOrganizationJobs (organizationId: number, startDate?: Date, endDate?: Date, limit?: number, offset?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListJobsResponse;  }> {
     ...
     * @param organizationId Organization ID
     */
    public async listOrganizationPipelines (organizationId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListOrganizationPipelinesResponse;  }> {
        const localVarPath = this.basePath + '/api/organizations/{organizationId}/pipelines'
            .replace('{' + 'organizationId' + '}', encodeURIComponent(String(organizationId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ListOrganizationPipelinesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param pipelineId Pipeline ID
     */
    public async runOrganizationPipeline (organizationId: number, pipelineId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RunOrganizationPipelineResponse;  }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RunOrganizationPipelineResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param organizationUpdatePipelineBody 
     */
    public async updateOrganizationPipeline (organizationId: number, pipelineId: number, organizationUpdatePipelineBody: OrganizationUpdatePipelineBody, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericApiResponse;  }> {
        const localVarPath = this.basePath + '/api/organizations/{organizationId}/pipelines/{pipelineId}'
            .replace('{' + 'organizationId' + '}', encodeURIComponent(String(organizationId)))
            .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
        let localVarQueryParameters: any = {};

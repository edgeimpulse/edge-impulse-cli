...
export class OrganizationDataApi {
    ...
    /**
     * Add a new data item. You can add a maximum of 1500 files directly through this API. Use `addOrganizationDataFile` to add additional files. Don\'t trust the code generated by the widget, there are examples of using this API in Python, cURL and Node.js under the parameters.

...
export class OrganizationPortalsApi {
     ...
     * @param portalId Portal ID
     */
    public async verifyOrganizationPortal (organizationId: number, portalId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VerifyOrganizationBucketResponse;  }> {

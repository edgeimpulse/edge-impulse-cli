...
export class AdminApi {
    ...
    public async adminAddDisallowedEmailDomain (adminAddDisallowedEmailDomainRequest: AdminAddDisallowedEmailDomainRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminAddDisallowedEmailDomainRequest);
    ...
    public async adminAddOrUpdateSSODomainIdPs (domainName: string, adminAddOrUpdateSSODomainIdPsRequest: AdminAddOrUpdateSSODomainIdPsRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminAddOrUpdateSSODomainIdPsRequest);
    ...
    public async adminCreateOauthClient (adminCreateOauthClientRequest: AdminCreateOauthClientRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminCreateOauthClientRequest);
    ...
    public async adminCreateOrganization (adminCreateOrganizationRequest: AdminCreateOrganizationRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminCreateOrganizationRequest);
    ...
    public async adminCreateSignupApprovalRequest (userId: number, adminCreateSignupApprovalRequest: AdminCreateSignupApprovalRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminCreateSignupApprovalRequest);
    ...
    public async adminCreateTrial (adminStartEnterpriseTrialRequest: AdminStartEnterpriseTrialRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminStartEnterpriseTrialRequest);
    ...
    public async adminDeleteOrganization (organizationId: number, queryParams?: adminDeleteOrganizationQueryParams, options: {
        ...
        if (typeof queryParams?.fullDeletion !== 'undefined' && queryParams?.fullDeletion !== null) {
            queryParameters['fullDeletion'] = <string><any>queryParams.fullDeletion;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async adminDeleteUser (userId: number, queryParams?: adminDeleteUserQueryParams, options: {
        ...
        if (typeof queryParams?.skipUserNotification !== 'undefined' && queryParams?.skipUserNotification !== null) {
            queryParameters['skipUserNotification'] = <string><any>queryParams.skipUserNotification;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async adminFindUser (queryParams: adminFindUserQueryParams, options: {
        ...
        if (typeof queryParams?.query !== 'undefined' && queryParams?.query !== null) {
            queryParameters['query'] = <string><any>queryParams.query;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async adminGetJobDetails (jobId: number, queryParams: adminGetJobDetailsQueryParams, options: {
        ...
        if (typeof queryParams?.parentType !== 'undefined' && queryParams?.parentType !== null) {
            queryParameters['parentType'] = <string><any>queryParams.parentType;
        }
        if (typeof queryParams?.includeChildrenJobs !== 'undefined' && queryParams?.includeChildrenJobs !== null) {
            queryParameters['includeChildrenJobs'] = <string><any>queryParams.includeChildrenJobs;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async adminListOrganizationData (organizationId: number, queryParams?: adminListOrganizationDataQueryParams, options: {
        ...
        if (typeof queryParams?.dataset !== 'undefined' && queryParams?.dataset !== null) {
            queryParameters['dataset'] = <string><any>queryParams.dataset;
        }
        if (typeof queryParams?.limit !== 'undefined' && queryParams?.limit !== null) {
            queryParameters['limit'] = <string><any>queryParams.limit;
        }
    ...
    public async adminListTrashbinOrganizationS3Files (organizationId: number, queryParams: adminListTrashbinOrganizationS3FilesQueryParams, options: {
        ...
        if (typeof queryParams?.prefix !== 'undefined' && queryParams?.prefix !== null) {
            queryParameters['prefix'] = <string><any>queryParams.prefix;
        }
        if (typeof queryParams?.sourceBucket !== 'undefined' && queryParams?.sourceBucket !== null) {
            queryParameters['sourceBucket'] = <string><any>queryParams.sourceBucket;
        }
        if (typeof queryParams?.continuationToken !== 'undefined' && queryParams?.continuationToken !== null) {
            queryParameters['continuationToken'] = <string><any>queryParams.continuationToken;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async adminProjectKillSwitch (projectId: number, queryParams?: adminProjectKillSwitchQueryParams, options: {
        ...
        if (typeof queryParams?.skipRevokeApiKeys !== 'undefined' && queryParams?.skipRevokeApiKeys !== null) {
            queryParameters['skipRevokeApiKeys'] = <string><any>queryParams.skipRevokeApiKeys;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
     ...
     */
    public async adminRetryDatasetVersioningQueue (projectActivityStagingWindowId: number, options: {
        headers: { [name: string]: string },
        responseHeadersCallback?: (headers: { [name: string]: string }) => void
    } = {headers: { } }) : Promise<GenericApiResponse> {
    ...
    public async adminSetStudioConfig (configKey: string, adminUpdateConfigRequest: AdminUpdateConfigRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminUpdateConfigRequest);
    ...
    public async adminToggleDataMigration (migrationId: string, adminToggleDataMigrationRequest: AdminToggleDataMigrationRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminToggleDataMigrationRequest);
    ...
    public async adminUpdateOauthClient (clientId: number, adminUpdateOauthClientRequest: AdminUpdateOauthClientRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminUpdateOauthClientRequest);
    ...
    public async adminUpdateTrial (enterpriseTrialId: number, adminUpdateTrialRequest: AdminUpdateTrialRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminUpdateTrialRequest);
    ...
    public async adminUpdateUserPermissions (userId: number, adminUpdateUserPermissionsRequest: AdminUpdateUserPermissionsRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(adminUpdateUserPermissionsRequest);

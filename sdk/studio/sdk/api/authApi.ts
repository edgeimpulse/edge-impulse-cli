...
export class AuthApi {
    ...
    public async discourse (queryParams: discourseQueryParams, options: {
        ...
        if (typeof queryParams?.sso !== 'undefined' && queryParams?.sso !== null) {
            queryParameters['sso'] = <string><any>queryParams.sso;
        }
        if (typeof queryParams?.sig !== 'undefined' && queryParams?.sig !== null) {
            queryParameters['sig'] = <string><any>queryParams.sig;
        }

...
export class LearnApi {
    ...
    public async getKerasMetadata (projectId: number, learnId: number, queryParams?: getKerasMetadataQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<KerasModelMetadataResponse> {
        ...
        if (typeof queryParams?.excludeLabels !== 'undefined' && queryParams?.excludeLabels !== null) {
            queryParameters['excludeLabels'] = <string><any>queryParams.excludeLabels;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async savePretrainedModelParameters (projectId: number, savePretrainedModelRequest: SavePretrainedModelRequest, queryParams?: savePretrainedModelParametersQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(savePretrainedModelRequest);
    ...
    public async setAnomaly (projectId: number, learnId: number, setAnomalyParameterRequest: SetAnomalyParameterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(setAnomalyParameterRequest);
    ...
    public async setVlmConfig (projectId: number, learnId: number, vlmConfigurationBase: VlmConfigurationBase, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<VlmSetConfigResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(vlmConfigurationBase);
    ...
    public async testPretrainedModel (projectId: number, testPretrainedModelRequest: TestPretrainedModelRequest, queryParams?: testPretrainedModelQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<TestPretrainedModelResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(testPretrainedModelRequest);
    ...
    public async testPretrainedModelImages (projectId: number, testPretrainedModelImagesRequest: TestPretrainedModelImagesRequest, queryParams?: testPretrainedModelImagesQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<TestPretrainedModelResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(testPretrainedModelImagesRequest);
    ...
    public async uploadPretrainedModel (projectId: number, params: uploadPretrainedModelFormParams, queryParams?: uploadPretrainedModelQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
        ...
        if (params.modelFile !== undefined) {
            ...
            for (const f of modelFileFiles) {
                localVarFormParams.append('modelFile', new Blob([new Uint8Array(f.value)], {
                    type: f.options.contentType
                }), f.options.filename);
            }
        }
        if (params.modelFileName !== undefined) {
            if (params.modelFileName !== null && params.modelFileName !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'modelFileName', serializeFormDataValue(params.modelFileName, 'string'));
            }
        }
        if (params.modelFileType !== undefined) {
            if (params.modelFileType !== null && params.modelFileType !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'modelFileType', serializeFormDataValue(params.modelFileType, 'string'));
            }
        }
        if (params.representativeFeatures !== undefined) {
            ...
            for (const f of representativeFeaturesFiles) {
                localVarFormParams.append('representativeFeatures', new Blob([new Uint8Array(f.value)], {
                    type: f.options.contentType
                }), f.options.filename);
            }
        }
        if (params.device !== undefined) {
            if (params.device !== null && params.device !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'device', serializeFormDataValue(params.device, 'string'));
            }
        }
        if (params.overrideInputShape !== undefined) {
            if (params.overrideInputShape) {
                ...
                const overrideInputShapeSerialized = serializableParams
                    ...
                    : serializeFormDataValue(params.overrideInputShape, 'Array<number>');

                localVarFormParams = appendFormField(localVarFormParams, 'overrideInputShape', overrideInputShapeSerialized);
            }
        }
        const queryString = Object.entries(queryParameters)
            .filter(([, value]) => value !== undefined)
    ...
    public async uploadPretrainedModelByUrl (projectId: number, uploadPretrainedModelByUrlRequest: UploadPretrainedModelByUrlRequest, queryParams?: uploadPretrainedModelByUrlQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(uploadPretrainedModelByUrlRequest);

...
export class OptimizationApi {
    ...
    public async getDspParameters (projectId: number, queryParams: getDspParametersQueryParams, options: {
        ...
        if (typeof queryParams?.organizationId !== 'undefined' && queryParams?.organizationId !== null) {
            queryParameters['organizationId'] = <string><any>queryParams.organizationId;
        }
        if (typeof queryParams?.organizationDspId !== 'undefined' && queryParams?.organizationDspId !== null) {
            queryParameters['organizationDspId'] = <string><any>queryParams.organizationDspId;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async updateConfig (projectId: number, optimizeConfig: OptimizeConfig, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(optimizeConfig);
    ...
    public async updateTunerRun (projectId: number, tunerCoordinatorJobId: number, updateTunerRunRequest: UpdateTunerRunRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(updateTunerRunRequest);

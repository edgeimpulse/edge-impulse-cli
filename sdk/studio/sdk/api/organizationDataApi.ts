...
export class OrganizationDataApi {
    ...
    public async addOrganizationBucket (organizationId: number, addOrganizationBucketRequest: AddOrganizationBucketRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(addOrganizationBucketRequest);
    ...
    public async addOrganizationDataFile (organizationId: number, dataId: number, params: addOrganizationDataFileFormParams, options: {
        ...
        if (params.files !== undefined) {
            ...
            for (const f of filesFiles) {
                localVarFormParams.append('files[]', new Blob([new Uint8Array(f.value)], {
    ...
    public async addOrganizationDataFolder (organizationId: number, organizationAddDataFolderRequest: OrganizationAddDataFolderRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(organizationAddDataFolderRequest);
    ...
    public async addOrganizationDataItem (organizationId: number, params: addOrganizationDataItemFormParams, options: {
        ...
        if (params.bucketId !== undefined) {
            if (params.bucketId !== null && params.bucketId !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'bucketId', serializeFormDataValue(params.bucketId, 'number'));
            }
        }
        if (params.bucketName !== undefined) {
            if (params.bucketName !== null && params.bucketName !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'bucketName', serializeFormDataValue(params.bucketName, 'string'));
            }
        }
        if (params.dataset !== undefined) {
            if (params.dataset !== null && params.dataset !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'dataset', serializeFormDataValue(params.dataset, 'string'));
            }
        }
        if (params.bucketPath !== undefined) {
            if (params.bucketPath !== null && params.bucketPath !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'bucketPath', serializeFormDataValue(params.bucketPath, 'string'));
            }
        }
        if (params.metadata !== undefined) {
            if (params.metadata !== null && params.metadata !== undefined) {
                localVarFormParams = appendFormField(localVarFormParams, 'metadata', serializeFormDataValue(params.metadata, 'string'));
            }
        }
        if (params.files !== undefined) {
            localVarFormParams = ensureFormData(localVarFormParams);
    ...
    public async addOrganizationDataset (organizationId: number, organizationAddDatasetRequest: OrganizationAddDatasetRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(organizationAddDatasetRequest);
    ...
    public async changeDatasetOrganizationDataItems (organizationId: number, setOrganizationDataDatasetRequest: SetOrganizationDataDatasetRequest, queryParams: changeDatasetOrganizationDataItemsQueryParams, options: {
        ...
        if (typeof queryParams?.dataIds !== 'undefined' && queryParams?.dataIds !== null) {
            queryParameters['dataIds'] = <string><any>queryParams.dataIds;
        }
        if (typeof queryParams?.filter !== 'undefined' && queryParams?.filter !== null) {
            queryParameters['filter'] = <string><any>queryParams.filter;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
        ...
        localVarRequestOptions.body = JSON.stringify(setOrganizationDataDatasetRequest);
    ...
    public async organizationBulkUpdateMetadata (organizationId: number, params: organizationBulkUpdateMetadataFormParams, options: {
        ...
        if (params.csvFile !== undefined) {
            ...
            for (const f of csvFileFiles) {
                localVarFormParams.append('csvFile', new Blob([new Uint8Array(f.value)], {
                    type: f.options.contentType
                }), f.options.filename);
            }
        }
    ...
    public async previewDefaultFilesInFolder (organizationId: number, dataset: string, previewDefaultFilesInFolderRequest: PreviewDefaultFilesInFolderRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(previewDefaultFilesInFolderRequest);
    ...
    public async updateOrganizationBucket (organizationId: number, bucketId: number, updateOrganizationBucketRequest: UpdateOrganizationBucketRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(updateOrganizationBucketRequest);
    ...
    public async updateOrganizationDataItem (organizationId: number, dataId: number, updateOrganizationDataItemRequest: UpdateOrganizationDataItemRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(updateOrganizationDataItemRequest);
    ...
    public async updateOrganizationDataset (organizationId: number, dataset: string, updateOrganizationDatasetRequest: UpdateOrganizationDatasetRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(updateOrganizationDatasetRequest);
    ...
    public async verifyExistingOrganizationBucket (organizationId: number, bucketId: number, verifyOrganizationExistingBucketRequest: VerifyOrganizationExistingBucketRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(verifyOrganizationExistingBucketRequest);
    ...
    public async verifyOrganizationBucket (organizationId: number, verifyOrganizationBucketRequest: VerifyOrganizationBucketRequest, options: {
        ...
        localVarRequestOptions.body = JSON.stringify(verifyOrganizationBucketRequest);

...
export class OrganizationJobsApi {
    ...
    public async listAllOrganizationJobs (organizationId: number, queryParams?: listAllOrganizationJobsQueryParams, options: {
        ...
        if (typeof queryParams?.excludePipelineTransformJobs !== 'undefined' && queryParams?.excludePipelineTransformJobs !== null) {
            queryParameters['excludePipelineTransformJobs'] = <string><any>queryParams.excludePipelineTransformJobs;
        }
        if (typeof queryParams?.rootOnly !== 'undefined' && queryParams?.rootOnly !== null) {
            queryParameters['rootOnly'] = <string><any>queryParams.rootOnly;
        }

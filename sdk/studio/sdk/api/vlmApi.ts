...
export class VlmApi {
    ...
    public async getVlmInference (projectId: number, learnId: number, queryParams?: getVlmInferenceQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<VlmGetInferenceResultsResponse> {
        ...
        if (typeof queryParams?.configId !== 'undefined' && queryParams?.configId !== null) {
            queryParameters['configId'] = <string><any>queryParams.configId;
        }
        localVarHeaderParams = {
            ...localVarHeaderParams,
            ...options.headers,
    ...
    public async runVlmInference (projectId: number, learnId: number, vlmInferenceRequest: VlmInferenceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
        ...
        localVarRequestOptions.body = JSON.stringify(vlmInferenceRequest);

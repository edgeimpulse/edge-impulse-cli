...
export const OAuthScopeValues: string[] = ['deployments:create', 'deployments:delete', 'deployments:read', 'deployments:update', 'devices:create', 'devices:delete', 'devices:read', 'devices:update', 'jobs:read', 'organizations:read', 'projects:apikeys:ingestiononly:create', 'projects:apikeys:ingestiononly:delete', 'projects:create', 'projects:delete', 'projects:read', 'projects:update', 'user:read', 'user:update'];

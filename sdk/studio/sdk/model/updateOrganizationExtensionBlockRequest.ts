...
export const UpdateOrganizationExtensionBlockRequestNavbarLocationEnumValues: string[] = [ 'project', 'devices', 'data_acquisition', 'experiments', 'create_impulse', 'dsp_block', 'learn_block', 'live_classification', 'model_testing', 'deployment', 'impulse', 'versioning' ];
